...
include <orangepi zero label.scad>
...
module orangepi_zero_hotShoe_adapters() {
    orangepi_zero_hotShoe_adapter_main();
    translate([- size.x * 2, 0, 0]) orangepi_zero_hotShoe_adapter_reverted();
    translate([- size.x * 3, 0, 0]) orangepi_zero_hotShoe_adapter_vertical();
    translate([- size.x * 4, 0, 0]) orangepi_zero_hotShoe_adapter_vertical_90_degrees();
}

module orangepi_zero_hotShoe_adapter_reverted() {
    orangepi_zero_hotShoe_adapter_base();
...
module orangepi_zero_hotShoe_adapter_main() {
    orangepi_zero_hotShoe_adapter_base();
    middlePoint = IntersectionOfLines(feet[0], feet[3], feet[2], feet[1]);
    translate([0, 0, hotShoeHeightClearance - baseHeight]) translate(- middlePoint) orangepi_zero_bracket();
}

module orangepi_zero_hotShoe_adapter_vertical() {
    orangepi_zero_hotShoe_adapter_base();
    middlePoint = IntersectionOfLines(feet[0], feet[3], feet[2], feet[1]);
