...
rotate([90, 0, 0]) board(opiZeroSize);
translate([0, 0, mpiMQProSize.x]) rotate([90, 90, 90]) board(mpiMQProSize);
translate([kvim3LSize.x, 0, kvim3LSize.x]) rotate([90, 90, 90]) board(kvim3LSize);