...
// Ensuite, il faudrait ceeeeeeeeeeeeeeeeeeeentrer la caaaaaaaaaaaaaaaaaaaaaaaaaaaaarte suivante

translate([0, 0, definitivePositionBoards[0].x.x]) rotate([90, 90, 0]) board(definitivePositionBoards[0].x,
definitivePositionBoards[0].y, definitivePositionBoards[0].z);
translate([- definitivePositionBoards[1].z - minDistanceBetweenBoards.x, minDistanceBetweenBoards.y,
    definitivePositionBoards[1].x.x]) rotate([90, 90, 90]
) board(definitivePositionBoards[1].x,
